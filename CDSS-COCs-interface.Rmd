...
server <- function(input, output) {
  ...
  alternative_treatments <- list(
    ...
    Management_of_Dysmenorrhea = c("POP", "DAPA"),
    Management_of_DUB_mild_moderate = c("Cyclic Continuous Progestin NET"),
    Management_of_DUB_severe = c("NET", "GNRI-Ia with NET add-back", "LNG-IUS"),
    Management_of_Hypothalamic_amenorrhea = c("Transdermal E2 and Progestin NET", "MPA"),
    Management_of_PCO_Polycystic_Ovary = c("POP", "Cyclic progestin", "Metformin"),
    Management_of_Endometriosis = c("GNRI-Ia and NET add-back", "NET alone", "DAPA"),
    Management_of_Primary_Ovary_Insufficient = c("Transdermal")
  )
  ...
  check_criteria <- function() {
    ...
    if (positive_condition_1) {
      ...
      alternatives <- alternative_treatments[[gsub(" ", "_", treatment_purpose)]]
      return(paste("Recommended treatments for", treatment_purpose, ":", paste(alternatives, collapse = ", ")))
